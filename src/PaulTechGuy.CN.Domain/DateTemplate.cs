...
/// Why you would choose this one. Shown next to the name, because "Photos land on today in
/// Google Photos" is only useful if you also learn that Google reads the Taken date.
/// </param>
...
public static class BuiltInTemplates
{
    ...
    [
        ...
        new DateTemplate(
            ...
            "Photos land on today in Google Photos",
            "The reverse. Scans, WhatsApp downloads and Facebook exports usually have a "
            + "sensible file date and no Taken date at all - which is exactly why Google "
            + "Photos dumps them on today. This writes the file date into the Taken date.",
            ...
            // most destructive thing in the starting set.
